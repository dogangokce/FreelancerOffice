...
$lang['form_validation_alpha_numeric_spaces'] = 'Bu {field} alan yanlızca alfasayısal karakterler içerebilir.';
...
$lang['form_validation_differs'] = 'Bu {field} alan  {param} alanından farklı olmalıdır.';
...
$lang['form_validation_less_than_equal_to'] = 'Bu {field} alan {param} alanından bir sayı veya eşit olmalıdır.';
$lang['form_validation_greater_than'] = '{field} alanına sadece {param} sayısından büyük değer girilmelidir.';
$lang['form_validation_greater_than_equal_to'] = 'Bu {field} alan {param} alanından bir sayı eşit veya büyük bir değer içermelidir.';
$lang['form_validation_error_message_not_set'] = 'Bu {field} alana karşılık gelen adımda hata içeriyor..';
$lang['form_validation_in_list'] = 'Bu {field} veya {param} başka alan açık olalıdır..';
